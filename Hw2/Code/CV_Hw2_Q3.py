...
if doCapture:
    ...
    video_name = 'chair_video.mp4'
    video_path = os.path.join(Data_dir,video_name)
    
    cap = cv2.VideoCapture(video_path)
    
    try:
        if not os.path.exists(os.path.join(Data_dir,'frames')):
            os.makedirs(os.path.join(Data_dir,'frames'))
    ...
    while(True):
        ...
        frame_path = os.path.join(Data_dir,'frames',name)
